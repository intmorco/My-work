...
// let genres = [...new Set(movies.map(movie => movie.Genre))] // 1

// Вытаскиваем все жанры из объектов в массиве
let duplicates = movies.map(movie => movie.Genre) // 1
// Удаляем все дубликаты из массива с помощью СЭТ
let unique_set = new Set(duplicates) // 2
// СЭТ переводим в массив {"action"} -> ["action"]
let genres = ["All",...unique_set] // 3
